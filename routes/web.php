...
/*
|--------------------------------------------------------------------------
| 3. WILAYAH UMUM & JALUR DATA (AUTH)
|--------------------------------------------------------------------------
*/
Route::middleware('auth')->group(function () {
    ...
    // --- KURIR DATA (AJAX) - Wajib kebuka buat semua role supaya dropdown gak macet ---
...
/*
|--------------------------------------------------------------------------
| 4. LEVEL 1: VIEWERS (Produksi, Staff, Kepala)
|--------------------------------------------------------------------------
| Hanya bisa LIHAT (GET). Tidak bisa Simpan/Hapus.
*/
Route::middleware(['auth', 'role:produksi,staff_ppic,kepala_ppic'])->group(function () {
    ...
    // History & Recap (Menghilangkan Error Route Not Found)
...
/*
|--------------------------------------------------------------------------
| 5. LEVEL 2: OPERATORS (Staff PPIC & Kepala PPIC)
|--------------------------------------------------------------------------
| Bisa LIHAT + INPUT/SIMPAN (POST). Tidak bisa EDIT/HAPUS.
*/
Route::middleware(['auth', 'role:staff_ppic,kepala_ppic'])->group(function () {
    ...
    Route::get('/rm/recap-log-print', [RmController::class, 'recapLogPrint'])->name('rm.recap_log_print');
    Route::get('/ppic-planning', [PPICController::class, 'index'])->name('ppic.index');
});

/*
|--------------------------------------------------------------------------
| 6. LEVEL 3: ADMIN / KEPALA (Hanya Kepala PPIC)
|--------------------------------------------------------------------------
| Akses MUTLAK: Bisa Edit (PUT/PATCH) & Hapus (DELETE).
*/
Route::middleware(['auth', 'role:kepala_ppic'])->group(function () {
    ...
    // Delete Buttons (The Kill Switches)
