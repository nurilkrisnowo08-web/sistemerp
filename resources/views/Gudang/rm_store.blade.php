            ...
            <table class="table table-ledger mb-0 text-center">
                ...
                <tbody>
                    ...
                    <tr class="rm-row-header" data-toggle="collapse" data-target="#det-{{ $slug }}">
                        ...
                        <td class="col-live text-center">{{ number_format($group->total_live) }}</td>
        ...
        <div class="modal-content border-0" style="border-radius: 12px; overflow:hidden; background: #f3f4f6;">
            <div class="modal-body p-4">
                <div class="label-container shadow-lg" style="background:#fff; padding:20px; border-radius:10px; border-top: 5px solid var(--primary);">
                    ...
                    <div class="row">
                        <div class="col-6 mb-2"><small class="text-muted d-block uppercase font-weight-bold">COIL_NO:</small><b id="v_coil" class="text-primary">--</b></div>
                        <div class="col-6 mb-2"><small class="text-muted d-block uppercase font-weight-bold">SPEC:</small><b id="v_spec">--</b></div>
                        <div class="col-6 mb-2"><small class="text-muted d-block uppercase font-weight-bold">SIZE:</small><b id="v_size">--</b></div>
                        <div class="col-6 mb-2"><small class="text-muted d-block uppercase font-weight-bold">TARGET_CYC:</small><b id="v_target">--</b></div>
                    </div>
                    <div class="bg-light p-3 rounded mt-2">
                        <small class="font-weight-bold d-block mb-1 uppercase" style="font-size: 10px;">Mapped Components:</small>
                        <div id="v_parts_list" class="d-flex flex-column gap-1"></div>
                    </div>
                    <div class="mt-3 text-center small text-muted font-weight-bold">STARTED: <span id="v_date">--</span></div>
                </div>
                <button class="btn btn-dark btn-block mt-4 py-3 font-weight-bold rounded-pill shadow" data-dismiss="modal">CLOSE DETAILS</button>
            </div>
        </div>
    </div>
</div>
