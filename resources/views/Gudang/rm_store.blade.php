...
<div class="container-fluid mt-4 animate__animated animate__fadeIn">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5">
        ...
        <div class="d-flex align-items-center mt-3 mt-md-0">
            ...
            <button class="btn btn-primary btn-cyber shadow-lg px-4 py-2 hover-lift" data-toggle="modal" data-target="#modalTambahRM">
    ...
    <div class="card-industrial p-4 mb-4 animate__animated animate__fadeInDown">
        <form action="{{ route('rm.store') }}" method="GET" id="autoFilterForm" class="row align-items-end">
            <div class="col-md-4">
                <label class="small font-weight-black text-primary mb-2 uppercase tracking-widest">Target Client Entity</label>
        ...
        <div class="modal-content border-0 shadow-2xl" style="border-radius: 40px; overflow: hidden;">
            ...
            <form action="{{ route('rm.update_unit_pcs') }}" method="POST">
                ...
                <div class="modal-body p-5 text-center">
                    ...
                    <input type="text" id="edit_coil" class="form-control tech-input text-center font-weight-black border-0 bg-transparent mb-4" style="font-size: 24px; color: var(--primary);" readonly>
                    
                    <label class="small font-weight-black text-muted uppercase mb-2 d-block text-left">Input Corrected Balance (PCS)</label>
            ...
            <form action="{{ route('rm.assign_part_to_unit') }}" method="POST">
                ...
                <div class="modal-body p-5">
                    ...
                    <div class="alert alert-primary rounded-2xl mb-4 border-0 text-center py-3">
                        ...
                        <p class="small font-weight-bold mb-0">Binding a component will allow this unit to be used as raw material for production.</p>
                    </div>
...
<script>
    ...
    function openAssignPart(id, customer) {
        ...
        $('#assign_select_part').html('<option>Loading component list...</option>');
        $.ajax({
    ...
    $(document).ready(function() {
        ...
        // Smart Logic AJAX (Sudah tertanam di dalam fungsi openAssignPart)
    });
</script>
@endsection