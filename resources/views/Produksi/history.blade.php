...
<style>
    ...
    @media print {
        ...
        /* Matikan SEMUA elemen Dashboard AdminLTE */
        nav, .main-sidebar, .main-header, .main-footer, .no-print, .btn, .filter-bar, .modal, .content-header { 
            display: none !important; 
        }

        /* Paksa content utama lebar 100% dan pindah ke paling kiri */
        .content-wrapper, .content, .container-fluid { 
            margin: 0 !important; padding: 0 !important; width: 100% !important; 
            max-width: 100% !important; background: white !important; left: 0 !important; position: absolute !important; top: 0 !important;
        }
...
<div class="container-fluid py-4 animate__animated animate__fadeIn">
    ...
    {{-- 🏛️ KOP SURAT PRINT (AMA KARAWANG) --}}
    <div class="print-only">
        <div class="print-header-brand">
            <table style="width: 100%;">
                <tr>
                    <td style="width: 80px;">
                        <div style="width: 70px; height: 70px; background: #000; color: #fff; text-align: center; line-height: 70px; font-weight: 900; border-radius: 12px; font-size: 22px;">AMA</div>
                    </td>
                    <td>
                        <h1 style="margin: 0; font-family: 'Orbitron'; font-weight: 900; font-size: 26px;">PT ASALTA MANDIRI AGUNG</h1>
                        <p style="margin: 0; font-size: 14px; font-weight: 700;">Kawasan Industri Mitrakarawang, Karawang, Jawa Barat - Indonesia</p>
                        <p style="margin: 0; font-size: 12px; text-transform: uppercase;">Final Production Audit & Quality History Report</p>
                    </td>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5 no-print">
        <div>
            <h2 class="heading-cyber m-0">PRODUCTION_AUDIT <span class="text-primary">v4.5</span></h2>
            <p class="text-muted small font-weight-bold mb-0 uppercase"><i class="fas fa-satellite-dish text-primary mr-2"></i> PT ASALTA MANDIRI AGUNG KARAWANG</p>
        </div>
    ...
    <div class="row mb-5">
        <div class="col-md-3 col-4 mb-3">
            <div class="stat-card">
                <div class="stat-label">Material Inbound</div>
        ...
        <div class="col-md-2 col-6 mb-3">
            <div class="stat-card"><div class="stat-label">Returned RM</div><div class="stat-value text-info">{{ number_format($totalRet) }}</div></div>
        </div>
        <div class="col-md-3 col-6 mb-3">
            <div class="stat-card bg-dark text-white"><div class="stat-label text-white-50">Operational Performance</div><div class="stat-value text-white">{{ number_format($performance, 1) }}%</div></div>
        </div>
    </div>
    ...
    <div class="print-only">
        ...
        <p style="text-align: right; font-size: 10px; margin-top: 30px;">Report Authenticated by System AMA // User: {{ Auth::user()->name }} // {{ now() }}</p>
    </div>
    ...
    <div class="text-center no-print mt-4 mb-5">
        <button onclick="window.print()" class="btn btn-dark btn-lg px-5 rounded-pill shadow-lg font-weight-black">
            <i class="fas fa-print mr-2"></i> GENERATE OFFICIAL PDF REPORT
        </button>
    </div>
</div>

{{-- 🛡️ MODAL DETAIL SAKTI (Full Data) --}}
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow-2xl border-0" style="border-radius: 35px;">
            ...
            <div class="modal-body p-5 bg-white text-left">
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-md-8 pl-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6"><small class="stat-label">Prod Time</small><div class="font-weight-bold small" id="det-time">-</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    <h6 class="font-weight-black text-danger small mb-3 uppercase border-bottom pb-2">Reject Breakdown Analysis:</h6>
...
<script>
    ...
    function showDetail(h) {
        ...
        document.getElementById('det-remark').innerText = h.keterangan || 'NO_REMARK';
        ...
        donut = new ApexCharts(document.querySelector("#modal-donut-yield"), donutOptions);
        donut.render();
