...
<div class="container-fluid py-4 px-4 animate__animated animate__fadeIn">
    ...
    {{-- ✨ KOTAKAN HISTORY PRODUKSI (Manggil view history Bapak) ✨ --}}
    <div class="mt-5 animate__animated animate__fadeIn">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="heading-hub m-0" style="font-size: 1.2rem; -webkit-text-fill-color: var(--dark-surface);">Production_Archive <span style="color: #64748b;">(Recent)</span></h3>
            <div class="badge badge-primary rounded-pill px-3 py-2 font-weight-bold" style="font-size: 10px; opacity: 0.8; letter-spacing: 1px;">LIVE_SYNC_ACTIVE</div>
        </div>

        <div class="ledger-container p-4">
            {{-- ✨ Manggil file welding_history_weldig rill ✨ --}}
