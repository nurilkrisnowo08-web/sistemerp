...
<div class="modal fade" id="modalDrilldown" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-2xl" style="border-radius: 30px;">
            <div class="modal-header bg-primary text-white p-4" style="border-radius: 30px 30px 0 0;">
...
<script>
    function showDrilldown(partNo, batches) {
        document.getElementById('drilldownTitle').innerText = "STAMPING_BATCH_LOG: " + partNo;
            ...
            batches.forEach(b => {
                body.innerHTML += `
                    <tr>
                        ...
                        <td><span class="badge badge-dark">${b.kode_Line || '-'}</span></td>
                        <td class="font-weight-black">${parseInt(b.qty_ambil_pcs).toLocaleString()}</td>
                        <td class="text-success font-weight-black">${parseInt(b.qty_hasil_ok).toLocaleString()}</td>
                        <td class="text-danger font-weight-black">${parseInt(b.qty_hasil_ng).toLocaleString()}</td>
                    </tr>
                `;
            });
        }
